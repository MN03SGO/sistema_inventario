 ...
 * @author sigaran
 */
public class editar_categoria extends javax.swing.JDialog {

    /**
     * Creates new form editar_categoria
     */
    public editar_categoria(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                editar_categoria dialog = new editar_categoria(new javax.swing.JFrame(), true);
